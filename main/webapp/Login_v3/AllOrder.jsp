		...
		<div class="container-login100 album py-5 bg-light"
			...
			<div class="container">
				...
				<ul class="nav nav-pills">
					<li class="nav-item"><input class="nav-link active" type="submit" name="classes" value="全部"></input></li>
					...
					<li class="nav-item"><input class="nav-link" type="submit" name="classes" value="飲品"></input></li>
				</ul>
				</form>
				<br />
				<div class="row">
